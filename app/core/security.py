...
def generate_refresh_token() -> str:
    """Jeton opaque à haute entropie (envoyé au client, jamais stocké en clair)."""
    return secrets.token_urlsafe(48)


def hash_refresh_token(token: str) -> str:
    """Hash SHA-256 stocké en base. Pas besoin de bcrypt : le jeton est déjà
    aléatoire et à haute entropie (contrairement à un mot de passe)."""
